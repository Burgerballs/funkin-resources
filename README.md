...
- - [BBPanzu's Psych Engine Tutorial](https://youtu.be/qxMyoudrFPs) - A long tutorial video that tells you in detail how to use Psych Engine. Although this tutorial is pretty old now, it's still really useful.
